...
ActiveRecord::Schema.define(version: 20160608120016) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.date     "date_of_implementation",             default: '2016-06-29'
  ...
  create_table "leaves", force: :cascade do |t|
    ...
    t.datetime "start_of_effectivity",             default: '2016-06-29 12:58:37'
    t.datetime "end_of_effectivity",               default: '2016-06-29 12:58:37'
  end
