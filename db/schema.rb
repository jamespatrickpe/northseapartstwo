...
ActiveRecord::Schema.define(version: 20151123052821) do
  ...
  create_table "try_models", force: :cascade do |t|
    t.string   "email",                  limit: 255, default: "", null: false
    t.string   "encrypted_password",     limit: 255, default: "", null: false
    t.string   "reset_password_token",   limit: 255
    t.datetime "reset_password_sent_at"
  ...
  add_index "try_models", ["email"], name: "index_try_models_on_email", unique: true, using: :btree
  add_index "try_models", ["reset_password_token"], name: "index_try_models_on_reset_password_token", unique: true, using: :btree
