module OfficialStarterSeed
  ...
  #Constants
  Constant.create( constant_type: 'human_resources.minimum_wage', value: '362.50', name: 'Minimum Wage', remark: nil, date_of_effectivity: Time.now - 1.day )
  Constant.create( constant_type: 'human_resources.preferred_rest_day', value: 'SUNDAY', name: 'Preferred Rest Day', remark: nil, date_of_effectivity: Time.now - 1.day )
  Constant.create( constant_type: 'human_resources.contract_days', value: '366', name: 'Default Duration of Contract (Days)', remark: nil, date_of_effectivity: Time.now - 1.day )
  Constant.create( constant_type: 'human_resources.time_start', value: '08:00', name: 'Usual time Start for Employee', remark: nil, date_of_effectivity: Time.now - 1.day )
  Constant.create( constant_type: 'human_resources.time_end', value: '17:00', name: 'Usual time End for Employee', remark: nil, date_of_effectivity: Time.now - 1.day )
