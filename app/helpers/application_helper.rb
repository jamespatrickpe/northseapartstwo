module ApplicationHelper
  ...
  def generic_table_theadlink(action, order_parameter)
    render(:partial => "core_partials/generic_table_footer", :locals => { :action => action, :order_parameter => order_parameter})
  end
