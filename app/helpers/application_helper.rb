module ApplicationHelper
  ...
  def generic_table_add_and_reset(add_link, reset_link, duties_link)
    render(:partial => "core_partials/generic_table_add_and_reset", :locals => { :add_link => add_link, :reset_link => reset_link, :duties_link => duties_link})
  end
